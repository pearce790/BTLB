...
for(M in c(4,9)){for(R in c(4,8,12,24)){for(theta in c(1,10,20,40)){
...
names(results) <- c("M","R","theta","Iter",paste0("mu",1:50),paste0("mu_map",1:50),
                    "theta_map",paste0("Xbar",1:50),paste0("nu",1:50),paste0("nu_map",1:50))
save(results,file=paste0("results/res_ConfSim_20240429_",iter,".Rdata"))
