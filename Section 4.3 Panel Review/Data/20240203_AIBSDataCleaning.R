...
rawdata <- read_excel("Section 4.3 Panel Review/Data/GrantPeerReview_Scoring_Ranking_DataA2.xlsx",
                      sheet = "Pnl2")
raw_assignments <- read_excel("Section 4.3 Panel Review/Data/GrantPeerReview_Scoring_Ranking_DataA2.xlsx",
                              sheet = "Pnl2_Assignments")
